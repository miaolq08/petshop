		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<h1 class="navbar-brand"><a href="index">宠物之家</a></h1>
				</div>
				<!--navbar-header-->
			...
			<div class="header-info">
				...
				<div class="header-right login">
					<a href="../user/my?username=${user1.username}"><span class="glyphicon glyphicon-user" aria-hidden="true">${user1.username}</span></a>
				</div>
