...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=alipay.trade.page.pay.jsp?id=${order.id} method=post
			target="_blank">
		...
		<form name=traderefund action=alipay.trade.refund.jsp?id=${order.id} method=post
			target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDout_trade_no").value="${order.id}";
		document.getElementById("WIDsubject").value = "${order.name}";
